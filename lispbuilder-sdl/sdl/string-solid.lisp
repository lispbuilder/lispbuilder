...
* `UTF8` when 'T' and TTF FONT is used, will use SDL's UTF8 drawing, instead of normal drawing.
...
;;; UTF 8 methods, simply redirect to the 'string' methods when TTF font isn't used

(defmethod _render-utf8-solid_ :around ((string string) (font font) (color color) free cache)
  (_render-string-solid_ string font color free cache))

(defmethod _draw-utf8-solid-*_ ((string string) (x integer) (y integer) justify (surface sdl-surface) (font bitmap-font) (color color))
  (_draw-string-solid-*_ string x y justify (if surface surface *default-display*) font color))
