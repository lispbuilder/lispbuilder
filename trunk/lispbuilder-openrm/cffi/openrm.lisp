...
(cffi:defcenum rm-enum-wrapper ;;#.(openrm-lispify "RMenum" 'enumname)
  ...
  (#.(openrm-lispify "MONO_CHANNEL" 'enumvalue :keyword) #x0273)
  (#.(openrm-lispify "REDBLUE_STEREO_CHANNEL" 'enumvalue :keyword) #x0274)
  (#.(openrm-lispify "BLUERED_STEREO_CHANNEL" 'enumvalue :keyword) #x0275)
  (#.(openrm-lispify "MBUF_STEREO_CHANNEL" 'enumvalue :keyword) #x0276)
  (#.(openrm-lispify "OFFSCREEN_MONO_CHANNEL" 'enumvalue :keyword) #x0277)
  (#.(openrm-lispify "OFFSCREEN_REDBLUE_STEREO_CHANNEL" 'enumvalue :keyword) #x0278)
  (#.(openrm-lispify "OFFSCREEN_BLUERED_STEREO_CHANNEL" 'enumvalue :keyword) #x0279)
  ...
  (#.(openrm-lispify "RENDERPASS_OPAQUE" 'enumvalue :keyword) #x0600)
  (#.(openrm-lispify "RENDERPASS_TRANSPARENT" 'enumvalue :keyword) #x0601)
  (#.(openrm-lispify "RENDERPASS_3D" 'enumvalue :keyword) #x0602)
  (#.(openrm-lispify "RENDERPASS_2D" 'enumvalue :keyword) #x0603)
  (#.(openrm-lispify "RENDERPASS_ALL" 'enumvalue :keyword) #x0604)
  (#.(openrm-lispify "NOTIFY_SILENCE" 'enumvalue :keyword) #x0610)
  (#.(openrm-lispify "NOTIFY_FULL" 'enumvalue :keyword) #x0611)
  (#.(openrm-lispify "RM_VIEW" 'enumvalue :keyword) #x0620)
  (#.(openrm-lispify "RM_RENDER" 'enumvalue :keyword) #x0621)
  (#.(openrm-lispify "PIPE_SERIAL" 'enumvalue :keyword) #x0630)
  (#.(openrm-lispify "PIPE_MULTISTAGE" 'enumvalue :keyword) #x0631)
  (#.(openrm-lispify "PIPE_MULTISTAGE_PARALLEL" 'enumvalue :keyword) #x0632)
  (#.(openrm-lispify "PIPE_MULTISTAGE_VIEW_PARALLEL" 'enumvalue :keyword) #x0633)
  (#.(openrm-lispify "PIPE_SERIAL_NOBLOCK" 'enumvalue :keyword) #x0634)
  (#.(openrm-lispify "PIPE_MULTISTAGE_NOBLOCK" 'enumvalue :keyword) #x0635)
  (#.(openrm-lispify "PIPE_MULTISTAGE_PARALLEL_NOBLOCK" 'enumvalue :keyword) #x0636)
  (#.(openrm-lispify "PIPE_GLX" 'enumvalue :keyword) #x0650)
  (#.(openrm-lispify "PIPE_WGL" 'enumvalue :keyword) #x0651)
  (#.(openrm-lispify "PIPE_CR" 'enumvalue :keyword) #x0652)
  (#.(openrm-lispify "PIPE_NOPLATFORM" 'enumvalue :keyword) #x0653)
