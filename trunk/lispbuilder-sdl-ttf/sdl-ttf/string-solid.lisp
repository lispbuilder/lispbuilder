...
(defmethod _draw-string-solid-*_ ((string string) (x integer) (y integer) justify (surface sdl:sdl-surface) (font sdl-ttf:ttf-font) (color sdl:color))
...
(defmethod _render-string-solid_ ((string string) (font sdl-ttf:ttf-font) (color sdl:color) free cache)
