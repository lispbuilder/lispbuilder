...
(cffi:defcfun ("SDL_UpperBlit" Upper-Blit) :int
  (src sdl-surface)
  (srcrect sdl-rectangle)
  (dst sdl-surface)
  (dstrect sdl-rectangle))

(cffi:defcfun ("SDL_FillRect" Fill-Rect) :int
  (dst sdl-surface)
  (dstrect sdl-rectangle)
  (color :unsigned-int))
...
(cffi:defcfun ("SDL_WM_SetCaption" WM-Set-Caption) :void
  (title sdl-string)
  (icon sdl-string))
...
(cffi:defcfun ("SDL_SetClipRect" Set-Clip-Rect) :void
  (surface sdl-surface)
  (rect sdl-rectangle))

(cffi:defcfun ("SDL_GetClipRect" Get-Clip-Rect) :void
  (surface sdl-surface)
  (rect sdl-rectangle))
