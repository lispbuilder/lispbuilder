...
; CHANGE THIS TO LOCATE YOUR SDL DLL
; Justin TODO Frank had some ideas on how to make this more flexible
;(defparameter *sdl-dll-filepath* "C:\\SDL-1.2.9\\lib\\sdl")

; use this, if your sdl library is in the system path, e.g. c:\windows\system32
(defparameter *sdl-dll-filepath* "sdl.dll")
...
(defun load-sdl-library()
  ...
  (if *SDL-LOADED*
      ...
      (progn 
	(format t "Loading SDL runtime~%")
	(cffi:load-foreign-library *sdl-dll-filepath*)
	(setf *SDL-LOADED* t))))
...
(defun unload-sdl-library()
  ...
  (if *SDL-LOADED*
      (progn 
	(cffi::close-foreign-library *sdl-dll-filepath*)
	(format t "Closed SDL runtime library~%")
	(setf *SDL-LOADED* nil))
