...
(defmethod _draw-string-shaded-*_ ((string string) (x integer) (y integer) (fg-color sdl:color) (bg-color sdl:color) justify (surface sdl:sdl-surface) (font sdl-ttf:ttf-font))
...
(defmethod _render-string-shaded_ ((string string) (fg-color sdl:color) (bg-color sdl:color) (font sdl-ttf:ttf-font) free cache)
  (let ((surf
