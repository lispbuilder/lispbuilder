...
(defun VERSION (x)
  (with-foreign-slots ((sdl-cffi::major sdl-cffi::minor sdl-cffi::patch) x (:struct sdl-cffi::SDL-version))
...
(defun image-linked-version ()
    (when (cffi:foreign-symbol-pointer "IMG_Linked_Version" :library 'sdl-image-cffi::sdl-image)
      (cffi:foreign-funcall-pointer (cffi:foreign-symbol-pointer "IMG_Linked_Version" :library 'sdl-cffi::sdl-image)
                                    () (:pointer (:struct sdl-cffi::sdl-version)))))
...
(defcfun ("IMG_LoadTyped_RW" IMG-Load-Typed-RW) (:pointer (:struct sdl-cffi::sdl-surface))
...
(defcfun ("IMG_Load" IMG-Load-img) (:pointer (:struct sdl-cffi::sdl-surface))
  (file :string))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_Load_RW(SDL_RWops *src, int freesrc);
(defcfun ("IMG_Load_RW" IMG-Load-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops)))
  (freesrc free-src))
...
(defcfun ("IMG_LoadBMP_RW" IMG-Load-BMP-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadGIF_RW(SDL_RWops *src) ;
(defcfun ("IMG_LoadGIF_RW" IMG-Load-GIF-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadJPG_RW(SDL_RWops *src) ;
(defcfun ("IMG_LoadJPG_RW" IMG-Load-JPG-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadLBM_RW(SDL_RWops *src) ;
(defcfun ("IMG_LoadLBM_RW" IMG-Load-LBM-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadPCX_RW(SDL_RWops *src) ;
(defcfun ("IMG_LoadPCX_RW" IMG-Load-PCX-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadPNG_RW(SDL_RWops *src) ;
(defcfun ("IMG_LoadPNG_RW" IMG-Load-PNG-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadPNM_RW(SDL_RWops *src) ;
(defcfun ("IMG_LoadPNM_RW" IMG-Load-PNM-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadTGA_RW(SDL_RWops *src) ;
(defcfun ("IMG_LoadTGA_RW" IMG-Load-TGA-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadTIF_RW(SDL_RWops *src) ;
(defcfun ("IMG_LoadTIF_RW" IMG-Load-TIF-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadXCF_RW(SDL_RWops *src) ;
(defcfun ("IMG_LoadXCF_RW" IMG-Load-XCF-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadXPM_RW(SDL_RWops *src) ;
(defcfun ("IMG_LoadXPM_RW" IMG-Load-XPM-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_LoadXV_RW(SDL_RWops *src) ;-
(defcfun ("IMG_LoadXV_RW" IMG-Load-XV-RW) (:pointer (:struct sdl-cffi::sdl-surface))
  (src (:pointer (:struct sdl-cffi::SDL-RWops))))

;; extern DECLSPEC SDL_Surface * SDLCALL IMG_ReadXPMFromArray(char **xpm);
(defcfun ("IMG_ReadXPMFromArray" IMG-Read-XPM-From-Array) (:pointer (:struct sdl-cffi::sdl-surface))
  (char :pointer))
